(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Case = /** @class */ (function () {
                ...
                Case.prototype.setcroixVisible = function (visiblecroix) {
                    this.visiblecroix = visiblecroix;
                };
                Case.prototype.setrondVisible = function (visiblerond) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameService = /** @class */ (function () {
                ...
                GameService.prototype.changementDeJoueur = function () {
                    if (this.tour === 0) {
                        this.tour = 1;
                        return 1;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Grille = /** @class */ (function () {
                ...
                Grille.prototype.initGame = function () {
                    this.nbCasesVides = 9;
                    // initialisation des cases
                    this.cases = [];
                    this.tour = 0;
                    for (var i = 0; i < this.nbCasesVides; i++) {
                        var oCase = new _case__WEBPACK_IMPORTED_MODULE_1__["Case"]();
                        oCase.setValue('');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Player = /** @class */ (function () {
                function Player(name, id, visible) {
                    this.name = name;
                    this.id = id;
                    this.visible = visible;
                }
                Player.prototype.setVisible = function () {
                    this.visible = 'block';
                };
                Player.prototype.setNoneVisible = function () {
                    this.visible = 'none';
                };
                Player.prototype.getVisible = function () {
                    return this.visible;
                };
                return Player;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactFormComponent = /** @class */ (function () {
                ...
                function ContactFormComponent() {
                    ...
                    var player1 = new _Core_player__WEBPACK_IMPORTED_MODULE_2__["Player"]("Ready player one", "player1", "block");
                    this.players.push(player1);
                    var player2 = new _Core_player__WEBPACK_IMPORTED_MODULE_2__["Player"]("Ready player two", "player2", "block");
                ...
                ContactFormComponent.prototype.log = function () {
                };
                ContactFormComponent.prototype.playGame = function () {
                    var _this = this;
                    this.sound1.stop();
                    this.sound2.stop();
                    this.sound1.play();
                    setTimeout(function () { _this.sound2.play(); }, 2000);
                    $("#overlay").modal('show');
                    setTimeout(function () {
                        $('#overlay').modal('hide');
                    }, 2000);
                ...
                ContactFormComponent.prototype.playAgain = function () {
                    this.onclickedplayagain.emit(true);
                    this.players[0].setVisible();
                    this.players[1].setNoneVisible();
                };
                ContactFormComponent.prototype.restart = function () {
                    this.onclickedplayagain.emit(true);
                    this.players[0].setVisible();
                    this.players[1].setVisible();
                };
                ContactFormComponent.prototype.stopSound = function (toggle) {
                    this.sound1.mute(toggle);
                    this.sound2.mute(toggle);
                    console.log(toggle);
                };
                ContactFormComponent.prototype.setVisible = function (tour) {
                    if (tour == 0) {
                        this.players[0].setVisible();
                        this.players[1].setNoneVisible();
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GrilleJeuComponent = /** @class */ (function () {
                function GrilleJeuComponent(grille, gameService, contact) {
                    this.grille = grille;
                ...
                GrilleJeuComponent.prototype.onclicked = function (agreed) {
                    this.playGame();
                };
                GrilleJeuComponent.prototype.onclickedplayagain = function (agreed) {
                    this.playAgain();
                };
                GrilleJeuComponent.prototype.playerClick = function (i) {
                    this.sound.stop();
                ...
                GrilleJeuComponent.prototype.play = function (i) {
                ...
                GrilleJeuComponent.prototype.playGame = function () {
                ...
                GrilleJeuComponent.prototype.playAgain = function () {
                    this.grille.initGame();
                    this.cases = this.grille.cases;
                ...
                GrilleJeuComponent.prototype.getVisibility = function (i, s) {
                ...
                GrilleJeuComponent.prototype.toggleSound = function () {
                ...
                GrilleJeuComponent.prototype.changePlayerText = function () {
                    if (this.tour === 0) {
                ...
                GrilleJeuComponent.prototype.ngOnInit = function () {
                };
                return GrilleJeuComponent;
            }());
            GrilleJeuComponent.ctorParameters = function () { return [
